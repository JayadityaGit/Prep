...
<details style="margin-bottom: 5px; margin-top : 10px; border: 1px solid #ccc; border-radius: 5px; padding: 8px;">
  ...
  <div align="center" style="margin-top: 10px;">
    <img src="https://res.cloudinary.com/dywrfit3t/image/upload/v1763980777/Screenshot_24-Nov_16-09-16_19722_d3dtci.png" 
         alt="Question Paper" 
         style="max-width: 90%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);" />
    <img src="https://res.cloudinary.com/dywrfit3t/image/upload/v1763980776/Screenshot_24-Nov_16-09-24_12067_bvcmzh.png" 
         alt="Question Paper" 
         style="max-width: 90%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);" />
</div>
</details>
