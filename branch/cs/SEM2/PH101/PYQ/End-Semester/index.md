...
<details style="margin-bottom: 5px; margin-top : 10px; border: 1px solid #ccc; border-radius: 5px; padding: 8px;">
  ...
  <div align="center" style="margin-top: 10px;">
    <img src="https://res.cloudinary.com/dywrfit3t/image/upload/v1763902892/Screenshot_23-Nov_18-31-05_26880_uzi4ol.png" 
         alt="Question Paper" 
         style="max-width: 90%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);" />
    <img src="https://res.cloudinary.com/dywrfit3t/image/upload/v1763902889/Screenshot_23-Nov_18-31-13_9426_p3i2cz.png" 
         alt="Question Paper" 
         style="max-width: 90%; height: auto; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.2);" />
</div>
</details>
